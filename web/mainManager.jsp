...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
    <div region="north" style="height: 100px;background-image: url('images/bg.jpg')">
        ...
        <div style="padding-top: 70px;padding-right: 20px;">当前用户：&nbsp;<span
                style="color: red; ">${sessionScope.get("currentUser")}</span></div>
    </div>
</div>
    ...
    <div class="row-fluid">
        <div class="span2 bs-docs-sidebar">
            <ul class="nav nav-list bs-docs-sidenav">
                <li><a href="${pageContext.request.contextPath}/employee/blank"><i class="icon-chevron-right"></i>首页</a>
                </li>
                <li><a href="${pageContext.request.contextPath}/employee/business"><i class="icon-chevron-right"></i>业务查看</a>
                </li>
                <li><a href="${pageContext.request.contextPath}/employee/sign"><i
                        class="icon-chevron-right"></i>打卡记录</a></li>
                <li><a href="${pageContext.request.contextPath}/employee/attendance"><i class="icon-chevron-right"></i>考勤查看</a>
                </li>
                <li><a href="${pageContext.request.contextPath}/employee/salary"><i class="icon-chevron-right"></i>工资查看</a>
                </li>
                <li><a href="${pageContext.request.contextPath}/employee/askLeave"><i class="icon-chevron-right"></i>请假记录</a>
                </li>
                <li><a href="${pageContext.request.contextPath}/employee/password"><i class="icon-chevron-right"></i>修改密码</a>
                </li>
