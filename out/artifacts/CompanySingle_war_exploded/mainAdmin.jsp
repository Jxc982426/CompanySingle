...
<body style="background-color: #1cd8d9">
...
<%--    <div region="north" style="height: 100px;background-image: url('./images/bg.jpg')">--%>
    <div region="north" style="height: 100px;">
        <div align="left" style="width: 80%;height:100px ;float: left;padding-top: 40px;padding-left: 30px;"><span
                style="color: white; font-size: x-large; ">公司综合管理系统</span></div>
        <div style="padding-top: 70px;padding-right: 20px;">当前用户：&nbsp;<span
<%--                style="color: red; ">${sessionScope.get("currentUser") }</span>--%>
<%--                style="color: red; ">${sessionScope.get["currentUser"] }</span>--%>
                style="color: red; ">${sessionScope.currentUser }</span>
        </div>
    </div>
</div>
    ...
    <div class="row-fluid">
        <div class="span2 bs-docs-sidebar">
            <ul class="nav nav-list bs-docs-sidenav">
                <li><a href="${pageContext.request.contextPath}/mana/blank"><i class="icon-chevron-right"></i>首页</a>
                </li>
                <li><a href="${pageContext.request.contextPath}/mana/employee?page=1"><i
                        class="icon-chevron-right"></i>员工管理</a></li>
                <%--					<li><a href="${pageContext.request.contextPath}/mana/transfer?action=list"><i class="icon-chevron-right"></i>岗位调动</a></li>--%>
                <%--					<li><a href="${pageContext.request.contextPath}/mana/transfer?action=list"><i class="icon-chevron-right"></i>岗位调动</a></li>--%>
                <li><a href="${pageContext.request.contextPath}/mana/transfer?page=1"><i
                        class="icon-chevron-right"></i>岗位调动</a></li>
                <li><a href="${pageContext.request.contextPath}/mana/attendance?page=1"><i
                        class="icon-chevron-right"></i>考勤管理</a></li>
                <li><a href="${pageContext.request.contextPath}/mana/askleave?page=1"><i
                        class="icon-chevron-right"></i>请假批准</a></li>
                <li><a href="${pageContext.request.contextPath}/mana/salary?page=1"><i
                        class="icon-chevron-right"></i>设置工资</a></li>
                <li><a href="${pageContext.request.contextPath}/mana/business?page=1"><i
                        class="icon-chevron-right"></i>业务管理</a></li>
                <li><a href="${pageContext.request.contextPath}/mana/password"><i
                        class="icon-chevron-right"></i>修改密码</a></li>
                <li><a href="${pageContext.request.contextPath}/index.jsp"><i class="icon-chevron-right"></i>退出系统</a></li>
            </ul>
        </div>
        <div class="span10">
